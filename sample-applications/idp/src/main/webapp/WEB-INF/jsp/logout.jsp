...
<%	
	...
	if (httpSession != null && httpSession.getAttribute(IdpSampleConstants.LOGOUT_KEY_PREFIX +
	    IdpSampleConstants.REF_ID_ADAPTER_REFERENCE) != null)
	{
		referenceId = (String) httpSession.getAttribute(IdpSampleConstants.LOGOUT_KEY_PREFIX +
		    IdpSampleConstants.REF_ID_ADAPTER_REFERENCE);
		httpSession.removeAttribute(IdpSampleConstants.LOGOUT_KEY_PREFIX +
		    IdpSampleConstants.REF_ID_ADAPTER_REFERENCE);
	}
	...
	{
	    pickupResponse =
			(ReferenceIdAdapterResponse) httpSession.getAttribute(IdpSampleConstants.LOGOUT_KEY_PREFIX +
	...
	{
		redirectURL = (String) httpSession.getAttribute(IdpSampleConstants.LOGOUT_KEY_PREFIX +
	...
	{
		redirectURLPath = (String) httpSession.getAttribute(IdpSampleConstants.LOGOUT_KEY_PREFIX +
